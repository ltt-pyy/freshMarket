		...
		<div class="navbar  navbar-inverse">
				<div class="navbar-inner">
					<div class="container">
						...
						<a class="brand" href="#">网上生鲜超市</a>
						<ul class="nav">
							<li class="active"><a href="index.jsp">首页</a></li>
							<li ><a href="newfresh.jsp">新品</a></li>
							<li ><a href="onsale.jsp">优惠</a></li>
							<li class="dropdown">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown">生鲜类别<b class="caret"></b></a>
								<ul class="dropdown-menu">
									<li><a href="selecttype.jsp?type=01">水果</a></li>
									<li><a href="selecttype.jsp?type=02">蔬菜</a></li>
									<li><a href="selecttype.jsp?type=03">海鲜</a></li>
									<li><a href="selecttype.jsp?type=04">畜禽</a></li>
									<li><a href="selecttype.jsp?type=05">饮品</a></li>
									<li><a href="selecttype.jsp?type=06">粮油</a></li>
									<li><a href="selecttype.jsp?type=07">零食</a></li>
								</ul>
							</li>
						</ul>
	                   ...
	                   %>
							...
							<li class="dropdown" id="person_cen">
								...
								<ul class="dropdown-menu" >
									...
									<li><a href="myOrder.jsp?userId=<%=request.getSession().getAttribute("id") %>">我的订单</a></li>
