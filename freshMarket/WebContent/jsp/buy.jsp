	...
	<body id="buy">
		...
		<div class="container" >
			...
			<div id="buy_conten">
			    ...
			    <div class="buy_info buy_boder"><strong>收货人信息 </strong>  <a href="newAddress.jsp?freshId=${freshId }&chooseNum=${chooseNum}" class="buy_add_adress">新增收货地址</a>
				    <div class="clearfix ">
                        <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu" >
                        <%
                        String userId=String.valueOf(request.getSession().getAttribute("id"));
                        List<AddressInfo> all = DAOFactory.getIAddressInfoDAOInstance().findAll(userId) ;
                        ...
                        %>
                            <li class="addList"><a tabindex="-1" href="#"> <%=addr.getAddname() %>  <%=addr.getAddr() %>  <%=addr.getPhone() %></a>
                             <input type="hidden" value="<%=addr.getAddId() %> ">
		...
		window.onload=function(){
			...
			addId.value=li[0].getElementsByTagName('input')[0].value;
			...
			for(var i=0;i<li.length;i++){
				li[i].onclick=function(){
				 ...
				 addId.value=this.getElementsByTagName('input')[0].value;
