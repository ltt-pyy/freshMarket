...
%>
	...
	<body id="pay_sub">
		...
		<div class="container">
			...
			<span><strong>订单提交成功，请您尽快付款！ 订单号：<%=request.getParameter("orderId")%></strong></span>
			
			<div class="pay_sub_conten">
				
				
				<form action="PayPasswordServlet" method="post">
				    <input type="hidden" name="orderno" value=<%=request.getParameter("orderId")%>>
				     <input type="hidden" name="addId" value=<%=request.getParameter("addId")%> >
