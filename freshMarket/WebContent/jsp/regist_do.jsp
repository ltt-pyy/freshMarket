...
<%
	if(DAOFactory.getIUserDAOInstance().doCreate(mem)){	// 注册成功
		response.setHeader("refresh","2;URL=index.jsp") ;
%>
		<h3>恭喜<%=mem.getUserId()%>用户注册成功，两秒后将跳转到登陆页！</h3>
